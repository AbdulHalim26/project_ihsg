...
const roadmapData = {
  dasar: [
    { step: 1, title: "Mengenal Dunia Saham", slug: "mengenal-dunia-saham", descCard: "Memahami saham sebagai kepemilikan bisnis & sejarah pasar modal di Indonesia.", modules: "3 modul", level: "Dasar", contentTitle: "Mengenal Dunia Saham", contentDesc: "Membangun landasan berpikir yang benar tentang investasi..." },
    { step: 2, title: "Ekosistem Bursa Efek", slug: "ekosistem-bursa-efek", descCard: "Mengenal peran OJK, IDX, KSEI, dan cara transaksi saham di balik layar.", modules: "3 modul", level: "Dasar", contentTitle: "Ekosistem Bursa Efek (BEI)", contentDesc: "Memahami siapa saja 'pemain' di balik layar pasar modal..." },
    ...
    { step: 4, title: "Membaca Aplikasi Trading", slug: "membaca-aplikasi-trading", descCard: "Bid, Offer, Lot, ARA (Auto Reject Atas), dan ARB (Auto Reject Bawah).", modules: "4 modul", level: "Dasar", contentTitle: "Membaca Aplikasi Trading", contentDesc: "Menguasai 'bahasa' pasar agar Anda bisa bertransaksi dengan percaya diri..." }
  ],
  menengah: [
    { step: 1, title: "Bedah Laporan Keuangan", slug: "bedah-laporan-keuangan", descCard: "Memahami data mentah perusahaan dari tiga pilar utama dengan baik.", modules: "Modul", level: "Menengah", contentTitle: "Bedah Laporan Keuangan", contentDesc: "Langkah pertama menuju kemandirian analisis adalah memahami data mentah perusahaan. Di sini Anda akan belajar membedah Neraca, Laba Rugi, dan Arus Kas untuk mengetahui kesehatan asli sebuah bisnis." },
    { step: 2, title: "Valuasi Saham (Murah vs Mahal)", slug: "valuasi-saham-dasar", descCard: "Belajar menghitung PER dan PBV agar tidak membeli saham kemahalan.", modules: "Modul", level: "Menengah", contentTitle: "Valuasi Saham Dasar", contentDesc: "Perusahaan bagus belum tentu sahamnya layak dibeli jika harganya sudah terlalu mahal. Pelajari metrik valuasi dasar seperti Price to Earning Ratio (PER) dan Price to Book Value (PBV)." },
    { step: 3, title: "Analisa Teknikal Lanjutan", slug: "analisa-teknikal-lanjutan", descCard: "Membaca Trend, Support, Resistance, dan indikator Moving Average.", modules: "Modul", level: "Menengah", contentTitle: "Analisa Teknikal Lanjutan", contentDesc: "Tingkatkan skill membaca grafik Anda. Temukan titik pantul harga (Support) dan titik rawan turun (Resistance), serta pahami arah tren menggunakan indikator Moving Average." },
    { step: 4, title: "Corporate Action", slug: "corporate-action", descCard: "Memahami efek Dividen, Right Issue, dan Stock Split pada harga saham.", modules: "Modul", level: "Menengah", contentTitle: "Corporate Action (Aksi Korporasi)", contentDesc: "Perusahaan sering melakukan aksi yang mengubah struktur sahamnya. Pahami jebakan 'Dividend Trap' dan manfaatkan peluang dari Right Issue atau Stock Split." }
  ],
  mahir: [
    { step: 1, title: "Money Management", slug: "money-management", descCard: "Menghitung persentase modal dan membatasi risiko secara matematis.", modules: "Modul", level: "Mahir", contentTitle: "Money Management & Position Sizing", contentDesc: "Level mahir dimulai dengan teknik Position Sizing untuk membatasi risiko secara matematis dan logis. Anda akan belajar cara agar modal Anda tetap aman meski pasar sedang krisis." },
    { step: 2, title: "Bandarmologi & Broker Summary", slug: "bandarmologi", descCard: "Melacak jejak uang besar (Big Fund) dan investor asing di pasar.", modules: "Modul", level: "Mahir", contentTitle: "Bandarmologi (Ilmu Arus Dana)", contentDesc: "Harga saham digerakkan oleh uang besar. Pelajari cara membaca Broker Summary untuk mendeteksi apakah saham sedang diakumulasi (dikumpulkan) atau didistribusi (dibuang) oleh institusi besar." },
    { step: 3, title: "Makro Ekonomi & Siklus Sektoral", slug: "makro-ekonomi", descCard: "Pengaruh suku bunga, inflasi, dan nilai tukar terhadap IHSG.", modules: "Modul", level: "Mahir", contentTitle: "Makro Ekonomi & Sektoral", contentDesc: "Investor besar melihat kondisi dunia sebelum membeli saham. Pahami bagaimana keputusan The Fed, tingkat inflasi, dan rotasi sektor bisnis sangat mempengaruhi portofolio Anda." },
    { step: 4, title: "Menyusun Trading Plan", slug: "trading-plan", descCard: "Membuat sistem trading mandiri yang mekanis dan tanpa emosi.", modules: "Modul", level: "Mahir", contentTitle: "Menyusun Trading/Investing Plan", contentDesc: "Lulus dari AKSARA berarti Anda bisa mandiri. Rangkum semua ilmu Anda ke dalam satu rencana baku: kapan harus beli, kapan harus Hold, dan kapan harus Cut Loss tanpa penyesalan." }
  ]
};
...
// --- INI KOMPONEN BARU UNTUK NGEWRAP SEARCHPARAMS ---
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-32 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 w-full max-w-5xl mx-auto items-center relative z-10 font-['Inter'] px-4" style={{ marginBottom: '80px' }}>
          {["dasar", "menengah", "mahir"].map((tab, index) => (
            <div key={tab} className={`flex ${index === 0 ? "justify-center md:justify-start" : index === 1 ? "justify-center" : "justify-center md:justify-end"}`}>
              <button
        ...
        <div className="relative w-full mx-auto max-w-6xl">
          ...
          <AnimatePresence mode="wait">
            <motion.div key={activeTab} initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -30 }} transition={{ duration: 0.3 }} className="w-full flex flex-col relative z-10">
              {roadmapData[activeTab].map((item, index) => (
                <Link href={`/edukasi/${item.slug}`} key={index} className="flex flex-col md:flex-row w-full items-stretch relative z-10 gap-8 md:gap-0 group cursor-pointer" style={{ paddingBottom: index === roadmapData[activeTab].length - 1 ? '0px' : '110px' }}>
                  ...
                  <div className="flex-1 w-full flex justify-start md:pl-10 lg:pl-16 relative z-10 items-start pt-0 md:pt-3">
                    <div className="w-full">
                      ...
                      <p className="text-sm md:text-[13px] text-justify md:text-left text-slate-600 dark:text-slate-300 font-light leading-relaxed">{item.contentDesc}</p>
                    </div>
                  </div>
                </Link>
              ))}
        ...
        <div className="mt-28 mb-16 text-center relative z-10">
          <h2 className="text-2xl md:text-2xl font-['Inter'] mb-16 tracking-tight text-slate-900 dark:text-white">Jadilah investor hebat seperti mereka</h2>
          <div className="flex flex-col items-center gap-y-20 w-full">
            <div className="flex justify-center items-center w-full max-w-[350px] mx-auto -space-x-8 relative z-10">
              {investorsData.map((inv, index) => (
                <motion.div key={inv.id} onClick={() => setSelectedInvestor(inv)} whileHover={{ y: -10, scale: 1.1, zIndex: 30 }} className={`w-20 h-20 rounded-full border-4 ${selectedInvestor?.id === inv.id ? 'border-emerald-500 scale-110' : 'border-slate-50 dark:border-[#0B1120]'} shadow-[0_0_15px_rgba(0,0,0,0.1)] dark:shadow-[0_0_25px_rgba(255,255,255,0.08)] relative z-10 cursor-pointer overflow-hidden transition-all duration-300 opacity-95 group hover:opacity-100 hover:shadow-[0_0_20px_rgba(72,187,120,0.4)]`} style={{ zIndex: investorsData.length - index }}>
            ...
            <AnimatePresence mode="wait">
              {selectedInvestor && (
                <motion.div key={selectedInvestor.id} initial={{ opacity: 0, y: -20, height: 0 }} animate={{ opacity: 1, y: 0, height: "auto" }} exit={{ opacity: 0, y: -20, height: 0 }} transition={{ duration: 0.3, ease: "easeInOut" }} className="w-full max-w-4xl mx-auto relative overflow-hidden z-30" style={{ marginTop: '80px' }}>
                  <div className="bg-white/90 dark:bg-slate-800/80 backdrop-blur-md rounded-2xl p-8 md:p-10 border border-slate-200 dark:border-slate-700 shadow-2xl relative text-left flex flex-col md:flex-row items-center md:items-start gap-8 overflow-hidden transition-colors duration-300">
                    <button onClick={() => setSelectedInvestor(null)} className="absolute flex items-center justify-center bg-slate-200 dark:bg-slate-700/80 hover:bg-slate-300 dark:hover:bg-slate-600 rounded-full text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white transition-all z-50 border border-slate-300 dark:border-slate-500/50 cursor-pointer" style={{ width: '40px', height: '40px', top: '24px', right: '24px' }}>✕</button>
...
export default function EdukasiPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-slate-50 dark:bg-[#0B1120] flex items-center justify-center text-slate-900 dark:text-white">Memuat Roadmap...</div>}>
      <RoadmapContent />
    </Suspense>
  );
}