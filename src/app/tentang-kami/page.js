...
export default function TentangKamiPage() {
  return (
    <main className="min-h-screen pt-[120px] pb-20 bg-[#0B1120] text-white font-sans">
      ...
      {/* ========================================== */}
      <section className="bg-[#151E2D] py-4 px-6 border-y border-slate-800 mb-16">
        <div className="max-w-6xl mx-auto flex flex-wrap justify-center gap-10 text-slate-300 text-sm font-medium">
          <Link href="#visi-misi" className="hover:text-emerald-400 transition-colors">
            Visi & Misi
          </Link>
          <Link href="#makna-logo" className="hover:text-emerald-400 transition-colors">
            Makna Logo
          </Link>
          <Link href="#sejarah" className="hover:text-emerald-400 transition-colors">
            Tonggak Sejarah
          </Link>
        </div>
      </section>
      ...
      <section id="visi-misi" className="py-16 px-6 max-w-6xl mx-auto mb-20 scroll-mt-[100px]">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold mb-8 uppercase tracking-wider">Visi</h2>
          <div className="bg-[#151E2D] p-8 rounded-2xl border border-slate-700 max-w-3xl mx-auto shadow-xl">
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold mb-10 uppercase tracking-wider">Misi</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {/* Misi Point 1 */}
            <div className="bg-[#151E2D] p-8 rounded-2xl border border-slate-700 hover:border-emerald-500/50 transition-all shadow-xl text-left flex gap-6">
              <div className="text-3xl font-extrabold text-emerald-400 flex-shrink-0">01</div>
            ...
            {/* Misi Point 2 */}
            <div className="bg-[#151E2D] p-8 rounded-2xl border border-slate-700 hover:border-emerald-500/50 transition-all shadow-xl text-left flex gap-6">
              <div className="text-3xl font-extrabold text-emerald-400 flex-shrink-0">02</div>
              <p className="text-slate-300 text-sm leading-relaxed">
            ...
            {/* Misi Point 3 */}
            <div className="bg-[#151E2D] p-8 rounded-2xl border border-slate-700 hover:border-emerald-500/50 transition-all shadow-xl text-left flex gap-6">
              <div className="text-3xl font-extrabold text-emerald-400 flex-shrink-0">03</div>
              <p className="text-slate-300 text-sm leading-relaxed">
            ...
            {/* Misi Point 4 */}
            <div className="bg-[#151E2D] p-8 rounded-2xl border border-slate-700 hover:border-emerald-500/50 transition-all shadow-xl text-left flex gap-6">
              <div className="text-3xl font-extrabold text-emerald-400 flex-shrink-0">04</div>
              <p className="text-slate-300 text-sm leading-relaxed">
     ...
     {/* ========================================== */}
      ...
      {/* ========================================== */}
      <section id="makna-logo" className="bg-[#151E2D] py-24 md:py-32 px-6 border-y border-slate-800 mb-20 scroll-mt-[100px]"> {/* <-- Tambah py-24 biar section ini punya napas */}
        <div className="max-w-6xl mx-auto">
          {/* Tambah margin-bottom di title biar ada jarak ke isinya */}
          <h2 className="text-3xl font-bold text-center mb-24 uppercase tracking-wider text-white">Makna Logo</h2>
          
          {/* GRID: Tambah gap-12 jadi gap-20 biar ada jarak tengah */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 lg:gap-24 items-center">
            
            {/* Left: Logo Image */}
            <div className="flex justify-center md:justify-end w-full">
              <div className="bg-white p-6 md:p-10 rounded-2xl shadow-xl w-full max-w-md flex items-center justify-center">
                <Image 
                  src="/logo-aksara.png" 
            ...
            <div className="text-slate-300 space-y-4 text-sm md:text-base leading-relaxed text-left">
              <p className="font-bold text-white uppercase tracking-wide">Makna dan logo AKSARA:</p>
              <ul className="list-disc pl-5 space-y-3 font-light">
                <li><strong className="text-emerald-400">Warna Biru:</strong> Melambangkan stabilitas, kepercayaan, dan profesionalisme dalam dunia keuangan.</li>
                <li><strong className="text-emerald-400">Garis Grafik Naik:</strong> Mewakili pertumbuhan dan keberhasilan investasi yang rasional.</li>
                <li><strong className="text-emerald-400">Huruf 'A':</strong> Membentuk kurva yang menggambarkan proses pembelajaran dan kemajuan.</li>
              </ul>
              <p className="font-bold text-white uppercase tracking-wide mt-6">Simbol grafis memiliki arti:</p>
              <ul className="list-disc pl-5 space-y-3 font-light">
                <li><strong className="text-emerald-400">Garis Dinamis:</strong> Menunjukkan ketangkasan dalam menganalisis data pasar secara *real-time*.</li>
                <li><strong className="text-emerald-400">Kombinasi Warna:</strong> Melambangkan komunitas investor yang saling mendukung dan berbagi pengetahuan.</li>
              </ul>
            </div>
      ...
      <section id="sejarah" className="py-16 px-6 max-w-4xl mx-auto mb-20 scroll-mt-[100px]">
        <h2 className="text-3xl font-bold mb-8 text-center uppercase tracking-wider text-white">Tonggak Sejarah</h2>
        
        {/* Teks Pengantar */}
        <p className="text-slate-300 text-base md:text-lg leading-relaxed font-light text-center mb-16">
        ...
        {/* TIMELINE WRAPPER (Pembungkus Garis Vertikal - Pastikan SEMUA fase di dalam sini!) */}
        <div className="relative border-l border-slate-600 ml-4 md:ml-8 space-y-12 pb-4">
          
          {/* Fase 1 */}
          <div className="relative pl-8 md:pl-12">
            <div className="absolute -left-[14px] top-0 bg-[#0B1120] w-7 text-center py-1 text-white font-bold text-lg leading-none">
              1
            </div>
            <h3 className="text-lg md:text-xl font-bold text-white mb-3">Fase Inisiasi: Kesenjangan Literasi (2024 – Awal 2025)</h3>
          ...
          <div className="relative pl-8 md:pl-12">
            ...
            <h3 className="text-lg md:text-xl font-bold text-white mb-3">Fase Riset & Kajian Akademis (Pertengahan 2025)</h3>
          ...
          <div className="relative pl-8 md:pl-12">
            ...
            <h3 className="text-lg md:text-xl font-bold text-white mb-3">Fase Pengembangan Ekosistem (Akhir 2025 – 2026)</h3>
            ...
            <ul className="list-disc pl-5 space-y-2 text-slate-300 text-sm md:text-base font-light leading-relaxed">
              <li><strong className="text-white font-medium">Edukasi Terstruktur:</strong> Berdasarkan Learning Path yang logis.</li>
              <li><strong className="text-white font-medium">Alat Analisis (Produk):</strong> Memfasilitasi pengambilan keputusan berbasis data.</li>
              <li><strong className="text-white font-medium">Kemitraan Strategis (Promosi):</strong> Menjamin bahwa pengguna hanya berinteraksi dengan entitas yang terdaftar dan diawasi oleh OJK.</li>
            </ul>
          </div>
          ...
          <div className="relative pl-8 md:pl-12">
            ...
            <h3 className="text-lg md:text-xl font-bold text-white mb-3">Masa Kini: Realisasi Investasi Masa Depan</h3>
            <p className="text-slate-300 text-sm md:text-base font-light leading-relaxed">
